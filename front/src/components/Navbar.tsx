...
const Navbars = () => {
  ...
  <div className="flex">
    ...
    <aside className="hidden md:block bg-blue-200 p-4 w-64 fixed h-screen z-20 overflow-y-auto">
      ...
      <ul>
        <li><a href="#" className="block text-gray-800 hover:text-blue-600 mb-2">Romance</a></li>
        <li><a href="#" className="block text-gray-800 hover:text-blue-600 mb-2">Thriller</a></li>
        <li><a href="#" className="block text-gray-800 hover:text-blue-600 mb-2">Fantaisie</a></li>
        <li><a href="#" className="block text-gray-800 hover:text-blue-600 mb-2">Science-fiction</a></li>
        <li><a href="#" className="block text-gray-800 hover:text-blue-600 mb-2">Développement personnel</a></li>
        <li><a href="#" className="block text-gray-800 hover:text-blue-600 mb-2">Biographie</a></li>
        <li><a href="#" className="block text-gray-800 hover:text-blue-600 mb-2">Jeunesse</a></li>
        <li><a href="#" className="block text-gray-800 hover:text-blue-600 mb-2">Manga</a></li>
        <li><a href="#" className="block text-gray-800 hover:text-blue-600 mb-2">Bande dessinée</a></li>
        <li><a href="#" className="block text-gray-800 hover:text-blue-600 mb-2">Classique</a></li>
      </ul>
    </aside>

    {/* Contenu principal avec la Navbar */}
    <div className=" flex-1 ml-0 md:ml-64"> {/* La marge à gauche de 64 pour faire de la place à la Sidebar mais elle prend toute la place quand celle ci disparait */}
      <header className="bg-stone-300 flex items-center justify-between p-4 fixed top-0  left-0 w-full pl-64 backdrop-blur-sm transition-all">
        ...
        <nav className="hidden md:flex gap-6 ">
          ...
          <a href="/books"><i className="fa-solid fa-book"></i><span className="whitespace-nowrap hidden xl:inline">Bibliothèque</span> </a>
