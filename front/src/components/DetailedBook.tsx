      ...
      <section className="bg-beige-50 p-4 md:p-8">
        <div className="flex flex-row items-center md:flex-row  md:gap-8">
          ...
          <div className="text-sm md:text-base max-w-xl">
            ...
            <p>
              <span className="font-semibold">Catégorie</span> : Manga
            </p>
            <p className="mb-2">
            ...
            <p>
              Maomao est toujours en mission au palais impérial, où elle
              continue d’utiliser son intelligence pour résoudre des mystères
              liés aux poisons et à la politique complexe qui règne dans
              l’empire. Ce tome approfondit les intrigues et les relations entre
              les personnages.
            </p>
